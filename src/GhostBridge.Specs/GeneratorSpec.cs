...
namespace GhostBridge.Specs
{
    public class GeneratorSpec
    {
        ...
        public class with_two_nested_specs : with_ghost_bridge
        {
            ...
            It should_set_the_namespace = () => output.ShouldContain("\r\nnamespace " + gb_ns + ".ChutzpahSpecs\r\n{");
        ...
        [Subject(typeof(MSBuildTask))]
        public class when_creating_a_multiple_tests_setting_the_proj_dir : with_ghost_bridge
        {
            ...
            It should_set_the_namespace = () => output.ShouldContain("\r\nnamespace fakeProject.ChutzpahSpecs\r\n{");
        ...
        [Subject(typeof(MSBuildTask))]
        public class when_creating_a_single_test_setting_the_namespace : with_ghost_bridge
        {
            ...
            //It have_behaves = () => output.ShouldContain("Behaves_like<a_passing_chutzpah_test> success");
        ...
        [Subject(typeof(MSBuildTask))]
        public class when_creating_a_single_test : with_ghost_bridge
        {
            Because of = () => Execute();
        ...
        public class with_ghost_bridge
        {
